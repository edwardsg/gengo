...
public class Consonant extends Phoneme {
    ...
    Consonant(int occurence, String symbol, Feature... features) {
    ...
    public enum Aspiration implements Feature {
    ...
    public enum Ejectivity implements Feature {
        EJECTIVE("Ejective");

        private final String name;

        Ejectivity(String name) {
            this.name = name;
        }
    }

    // Rounding of lips
    public enum Labialization implements Feature {
        LABIALIZED("Labialized");

        private final String name;

        Labialization(String name) {
            this.name = name;
        }
    }
