...
import gengo.phonology.Consonant.Ejectivity;
import gengo.phonology.Consonant.Labialization;
import gengo.phonology.Consonant.Manner;
import gengo.phonology.Consonant.Place;
import gengo.phonology.Consonant.Voice;
import gengo.phonology.Vowel.Backness;
import gengo.phonology.Vowel.Height;
import gengo.phonology.Vowel.Length;
import gengo.phonology.Vowel.Nasalization;
import gengo.phonology.Vowel.Roundedness;

public class IPA {
	public static List<Consonant> CONSONANTS = new ArrayList<Consonant>();
	public static List<Vowel> VOWELS = new ArrayList<Vowel>();
	
	/* Consonants */
	public static final Consonant VD_BILABIAL_NASAL							= new Consonant(425, "m", Voice.VOICED, Place.BILABIAL, Manner.NASAL);					// UPSID   m
	...
	public static final Consonant VL_GLOTTAL_FRICATIVE						= new Consonant(279, "h", Voice.VOICELESS, Place.GLOTTAL, Manner.NONSIB_FRICATIVE);			// h
	public static final Consonant VD_VELAR_STOP								= new Consonant(253, "g", Voice.VOICED, Place.VELAR, Manner.STOP);								// g
	public static final Consonant VD_VELAR_NASAL							= new Consonant(237, "\u014B", Voice.VOICED, Place.VELAR, Manner.NASAL);						// N
	public static final Consonant VL_GLOTTAL_STOP							= new Consonant(216, "\u0294", Voice.VOICELESS, Place.GLOTTAL, Manner.STOP);					// ?
	public static final Consonant VD_ALVEOLAR_NASAL							= new Consonant(202, "n", Voice.VOICED, Place.ALVEOLAR, Manner.NASAL);							// n
	public static final Consonant VL_ALVEOLAR_SIB_FRICATIVE					= new Consonant(196, "s", Voice.VOICELESS, Place.ALVEOLAR, Manner.SIB_FRICATIVE);				// s
...
//	public static final Consonant VLA_BILABIAL_STOP							= new Consonant(101, "p\u02B0", Voice.VOICELESS, Aspiration.ASPIRATED, Place.BILABIAL, Manner.STOP);// ph
	...
	public static final Consonant VD_LABIODENTAL_FRICATIVE					= new Consonant(95, "v", Voice.VOICED, Place.LABIODENTAL, Manner.NONSIB_FRICATIVE);			// v
	public static final Consonant VL_VELAR_FRICATIVE						= new Consonant(94, "x", Voice.VOICELESS, Place.VELAR, Manner.NONSIB_FRICATIVE);							// x
...
//	public static final Consonant VD_DENTAL_STOP							= new Consonant(Voice.VOICED, Place.DENTAL, Manner.STOP, 80, "d");							// dD	*
	public static final Consonant VL_VELAR_EJECTIVE_STOP					= new Consonant(63, "k\u02BC", Voice.VOICELESS, Place.VELAR, Ejectivity.EJECTIVE, Manner.STOP);							// k'
	...
	public static final Consonant VD_ALVEOLAR_SIB_FRICATIVE					= new Consonant(62, "z", Voice.VOICED, Place.ALVEOLAR, Manner.SIB_FRICATIVE);							// z
	public static final Consonant VD_PALATO_ALVEOLAR_SIB_FRICATIVE			= new Consonant(61, "\u0292", Voice.VOICED, Place.PALATO_ALVEOLAR, Manner.SIB_FRICATIVE);							// Z
//	public static final Consonant LABIALIZED_VL_VELAR_STOP					= new Consonant(60, "k\u02B7", Labialization.LABIALIZED, Voice.VOICELESS, Place.VELAR, Manner.STOP);							// kW
	public static final Consonant VD_VELAR_FRICATIVE						= new Consonant(55, "\u0263", Voice.VOICED, Place.VELAR, Manner.NONSIB_FRICATIVE);							// gF
	public static final Consonant VD_BILABIAL_FRICATIVE						= new Consonant(54, "\u03B2", Voice.VOICED, Place.BILABIAL, Manner.NONSIB_FRICATIVE);							// B
	public static final Consonant VL_PALATAL_STOP							= new Consonant(54, "c", Voice.VOICELESS, Place.PALATAL, Manner.STOP);							// c
	public static final Consonant VL_UVULAR_STOP							= new Consonant(52, "q", Voice.VOICELESS, Place.UVULAR, Manner.STOP);							// q
...
//	public static final Consonant VD_PALATO_ALVEOLAR_NASAL					= new Consonant(Voice.VOICED, Place.PALATO_ALVEOLAR, Manner.NASAL, 45, "n");							// n_
	...
	public static final Consonant VL_PALATO_ALVEOLAR_EJECTIVE_SIB_AFFRICATE	= new Consonant(44, "t\u0361\u0283\u02BC", Voice.VOICELESS, Place.PALATO_ALVEOLAR, Ejectivity.EJECTIVE, Manner.SIB_AFFRICATE);					// tS'
//	public static final Consonant VD_DENTAL_ALVEOLAR_SIB_FRICATIVE			= new Consonant(Voice.VOICED, Place.DENTAL, Manner.SIB_FRICATIVE, 43, "z");							// "z
	public static final Consonant VD_PALATAL_STOP							= new Consonant(43, "\u025F", Voice.VOICED, Place.PALATAL, Manner.STOP);							// dj
//	public static final Consonant VL_DENTAL_SIB_FRICATIVE					= new Consonant(Voice.VOICELESS, Place.DENTAL, Manner.SIB_FRICATIVE, 42, "s");							// sD	*
	public static final Consonant VL_BILABIAL_FRICATIVE						= new Consonant(39, "\u0278", Voice.VOICELESS, Place.BILABIAL, Manner.NONSIB_FRICATIVE);							// P
	public static final Consonant VD_LABIAL_VELAR_STOP						= new Consonant(39, "g\u0361b", Voice.VOICED, Place.BILABIAL, Place.VELAR, Manner.STOP);							// gb	*
...
//	public static final Consonant VD_DENTAL_LAT_APPROXIMANT					= new Consonant(Voice.VOICED, Place.DENTAL, Manner.LAT_APPROXIMANT, 34, "l");							// lD	*
	public static final Consonant VL_RETROFLEX_STOP							= new Consonant(34, "\u0288", Voice.VOICELESS, Place.RETROFLEX, Manner.STOP);							// t.
...
//	public static final Consonant LABIALIZED_VD_VELAR_STOP					= new Consonant(24, "g\u02B7", Labialization.LABIALIZED, Voice.VOICED, Place.VELAR, Manner.STOP);							// gW
	public static final Consonant VD_RETROFLEX_NASAL						= new Consonant(24, "\u0273", Voice.VOICED, Place.RETROFLEX, Manner.NASAL);							// n.
	public static final Consonant VL_ALVEOLAR_EJECTIVE_STOP					= new Consonant(24, "t\u02BC", Voice.VOICELESS, Place.ALVEOLAR, Ejectivity.EJECTIVE, Manner.STOP);							// t'
	public static final Consonant VD_ALVEOLAR_IMPLOSIVE						= new Consonant(23, "\u0257", Voice.VOICED, Place.ALVEOLAR, Manner.IMPLOSIVE);							// d<
//	public static final Consonant LABIALIZED_VL_VELAR_EJECTIVE_STOP			= new Consonant(23, "k\u02B7\u02BC", Labialization.LABIALIZED, Voice.VOICELESS, Place.VELAR, Ejectivity.EJECTIVE, Manner.STOP);							// kW'
	public static final Consonant VL_RETROFLEX_SIB_FRICATIVE				= new Consonant(23, "\u0282", Voice.VOICELESS, Place.RETROFLEX, Manner.SIB_FRICATIVE);							// s.
	...
	public static final Consonant VD_UVULAR_FRICATIVE						= new Consonant(22, "\u0281", Voice.VOICED, Place.UVULAR, Manner.NONSIB_FRICATIVE);							// RF
	public static final Consonant VL_ALVEOLAR_LAT_FRICATIVE					= new Consonant(22, "\u026C", Voice.VOICELESS, Place.ALVEOLAR, Manner.LAT_FRICATIVE);							// hlF
...
//	public static final Consonant VD_DENTAL_ALVEOLAR_SIB_AFFRICATE			= new Consonant(Voice.VOICED, Place.DENTAL, Manner.SIB_AFFRICATE, 20, "d\u0361z");							// "dz
	public static final Consonant VD_PALATAL_LAT_APPROXIMANT				= new Consonant(20, "\u028E", Voice.VOICED, Place.PALATAL, Manner.LAT_APPROXIMANT);							// lj
...
//	public static final Consonant VD_BILABIAL_APPROXIMANT					= new Consonant(Voice.VOICED, Place.BILABIAL, Manner.APPROXIMANT, 19, "\u03B2");							// BA
	public static final Consonant VL_PHARYNGEAL_FRICATIVE					= new Consonant(19, "\u0127", Voice.VOICELESS, Place.PHARYNGEAL, Manner.NONSIB_FRICATIVE);							// H
...
//	public static final Consonant VD_DENTAL_SIB_FRICATIVE					= new Consonant(Voice.VOICED, Place.DENTAL, Manner.SIB_FRICATIVE, 17, "z");							// zD	*
	public static final Consonant VD_GLOTTAL_FRICATIVE						= new Consonant(16, "\u0266", Voice.VOICED, Place.GLOTTAL, Manner.NONSIB_FRICATIVE);							// hh
...
//	public static final Consonant VD_DENTAL_IMPLOSIVE						= new Consonant(Voice.VOICED, Place.DENTAL, Manner.IMPLOSIVE, 14, "\u0257");							// "d<
	public static final Consonant VD_UVULAR_STOP							= new Consonant(14, "\u0262", Voice.VOICED, Place.UVULAR, Manner.STOP);							// G
...
//	public static final Consonant PALATALIZED_VL_BILABIAL_STOP				= new Consonant(13, "p\u02B2", Voice.VOICELESS, Place.BILABIAL, Manner.STOP);							// pJ
	...
	public static final Consonant VD_PALATAL_FRICATIVE						= new Consonant(12, "\u029D", Voice.VOICED, Place.PALATAL, Manner.NONSIB_FRICATIVE);							// jF
...
//	public static final Consonant VL_DENTAL_LAT_APPROXIMANT					= new Consonant(Voice.VOICELESS, Place.DENTAL, Manner.LAT_APPROXIMANT, 10, "l\u0325");							// "hl
	public static final Consonant VD_PHARYNGEAL_FRICATIVE					= new Consonant(10, "\u0295", Voice.VOICED, Place.PHARYNGEAL, Manner.NONSIB_FRICATIVE);							// 9
...
//	public static final Consonant VL_DENTAL_NASAL							= new Consonant(Voice.VOICELESS, Place.DENTAL, Manner.NASAL, 9, "n\u0325");							// "hn	*
	public static final Consonant VL_ALVEOLO_PALATAL_SIB_FRICATIVE			= new Consonant(9, "\u0255", Voice.VOICELESS, Place.ALVEOLO_PALATAL, Manner.SIB_FRICATIVE);							// C,
//	public static final Consonant BVD_BILABIAL_STOP							= new Consonant(9, "b\u0324", Voice.BREATHY, Place.BILABIAL, Manner.STOP);							// bh
	public static final Consonant VL_PALATAL_EJECTIVE_STOP					= new Consonant(9, "c\u02BC", Voice.VOICELESS, Place.PALATAL, Ejectivity.EJECTIVE, Manner.STOP);							// c'
	...
	public static final Consonant VD_ALVEOLAR_LAT_FLAP						= new Consonant(9, "\u027A", Voice.VOICED, Place.ALVEOLAR, Manner.LAT_FLAP);							// l[
...
//	public static final Consonant VLA_RETROFLEX_SIB_AFFRICATE				= new Consonant(9, "\u0288\u0361s\u02B0", Voice.VOICELESS, Aspiration.ASPIRATED, Place.RETROFLEX, Manner.SIB_AFFRICATE);							// t.sh
	public static final Consonant VL_ALVEOLAR_EJECTIVE_LAT_AFFRICATE		= new Consonant(9, "t\u0361\u026C\u02BC", Voice.VOICELESS, Place.ALVEOLAR, Ejectivity.EJECTIVE, Manner.LAT_AFFRICATE);							// tlF'
	public static final Consonant VD_RETROFLEX_SIB_FRICATIVE				= new Consonant(9, "\u0290", Voice.VOICED, Place.RETROFLEX, Manner.SIB_FRICATIVE);							// z.
...
//	public static final Consonant PALATALIZED_VD_BILABIAL_STOP				= new Consonant(8, "b\u02B2", Voice.VOICED, Place.BILABIAL, Manner.STOP);							// bJ
	...
	public static final Consonant VD_RETROFLEX_LAT_FLAP						= new Consonant(8, "\u027A\u0306", Voice.VOICED, Place.RETROFLEX, Manner.LAT_FLAP);							// l.[
	public static final Consonant VD_ALVEOLAR_LAT_FRICATIVE					= new Consonant(8, "\u026E", Voice.VOICED, Place.ALVEOLAR, Manner.LAT_FRICATIVE);							// lF
...
//	public static final Consonant PALATALIZED_VL_DENTAL_SIB_FRICATIVE		= new Consonant(Voice.VOICELESS, Place.DENTAL, Manner.SIB_FRICATIVE, 7, "s\u02B2");							// "sJ	*
	public static final Consonant VD_LABIAL_VELAR_NASAL						= new Consonant(7, "\u014B\u0361m", Voice.VOICED, Place.BILABIAL, Place.VELAR, Manner.NASAL);							// Nm
...
//	public static final Consonant BVD_DENTAL_STOP							= new Consonant(Voice.BREATHY, Place.DENTAL, Manner.STOP, 5, "d\u0324");							// dDh	*
	public static final Consonant VD_VELAR_IMPLOSIVE						= new Consonant(5, "\u0260", Voice.VOICED, Place.VELAR, Manner.IMPLOSIVE);							// g<
...
//	public static final Consonant PRENASALIZED_VD_ALVEOLAR_SIB_AFFRICATE	= new Consonant(5, "nd\u0361z", Voice.VOICED, Place.ALVEOLAR, Manner.SIB_AFFRICATE);							// ndz
	public static final Consonant NASALIZED_VD_DENTAL_AFFRICATED_CLICK		= new Consonant(5, "\u01C0\u0303", Voice.VOICED, Place.DENTAL, Manner.CLICK);							// n|
...
//	public static final Consonant PALATALIZED_VD_LABIODENTAL_FRICATIVE		= new Consonant(5, "v\u02B2", Voice.VOICED, Place.LABIODENTAL, Manner.NONSIB_FRICATIVE);							// vJ
	public static final Consonant VL_DENTAL_AFFRICATED_CLICK				= new Consonant(5, "\u01C0", Voice.VOICED, Place.ALVEOLAR, Manner.CLICK);							// |
...
//	public static final Vowel CLOSE_MID_FRONT_UR		= new Vowel(124, "e", Height.CLOSE_MID, Backness.FRONT, Roundedness.UNROUNDED); 										// e
	public static final Vowel N_OPEN_CENTRAL_UR			= new Vowel(83, "a\u0303", Nasalization.NASAL, Height.OPEN, Backness.CENTRAL, Roundedness.UNROUNDED); 					// a~
	public static final Vowel N_CLOSE_FRONT_UR			= new Vowel(82, "i\u0303", Nasalization.NASAL, Height.CLOSE, Backness.FRONT, Roundedness.UNROUNDED);						// i~
	...
	public static final Vowel N_CLOSE_BACK_RD			= new Vowel(74, "u\u0303", Nasalization.NASAL, Height.CLOSE, Backness.BACK, Roundedness.ROUNDED); 						// u~
	...
	public static final Vowel N_MID_BACK_RD				= new Vowel(35, "o\u0303", Nasalization.NASAL, Height.MID, Backness.BACK, Roundedness.ROUNDED); 							// "o~	*
	public static final Vowel N_OPEN_MID_FRONT_UR		= new Vowel(35, "\u025B\u0303", Nasalization.NASAL, Height.OPEN_MID, Backness.FRONT, Roundedness.UNROUNDED); 				// E~
	...
	public static final Vowel N_MID_FRONT_UR			= new Vowel(33, "e\u0303", Nasalization.NASAL, Height.MID, Backness.FRONT, Roundedness.UNROUNDED); 						// "e~	*
	public static final Vowel N_OPEN_MID_BACK_RD		= new Vowel(32, "\u0254\u0303", Nasalization.NASAL, Height.OPEN_MID, Backness.BACK, Roundedness.ROUNDED); 				// O~
...
//	public static final Vowel N_CLOSE_MID_FRONT_UR		= new Vowel(18, "e\u0303", Nasalization.NASAL, Height.CLOSE_MID, Backness.FRONT, Roundedness.UNROUNDED); 					// e~
	...
	public static final Vowel N_MID_CENTRAL_UR			= new Vowel(12, "\u0259\u0303", Nasalization.NASAL, Height.MID, Backness.CENTRAL, Roundedness.UNROUNDED); 				// "@~
	...
	public static final Vowel N_CLOSE_CENTRAL_UR		= new Vowel(11, "\u0268\u0303", Nasalization.NASAL, Height.CLOSE, Backness.CENTRAL, Roundedness.UNROUNDED); 				// i_~
	public static final Vowel N_NEAR_CLOSE_NEAR_FRONT_UR= new Vowel(10, "\u026A\u0303", Nasalization.NASAL, Height.NEAR_CLOSE, Backness.NEAR_FRONT, Roundedness.UNROUNDED);		// I~
	public static final Vowel OPEN_MID_BACK_UR			= new Vowel(10, "\u028C", Height.OPEN_MID, Backness.BACK, Roundedness.UNROUNDED); 										// ^
	public static final Vowel N_NEAR_OPEN_FRONT_UR		= new Vowel(10, "\u00E6\u0303", Nasalization.NASAL, Height.NEAR_OPEN, Backness.FRONT, Roundedness.UNROUNDED); 			// aa~
	public static final Vowel N_NEAR_CLOSE_NEAR_BACK_RD	= new Vowel(9, "\u028A\u0303", Nasalization.NASAL, Height.NEAR_CLOSE, Backness.NEAR_BACK, Roundedness.ROUNDED); 			// U~
//	public static final Vowel MID_BACK_UR				= new Vowel(8, "\u0264", Height.MID, Backness.BACK, Roundedness.UNROUNDED); 											// "o(	*
	...
	public static final Vowel LN_CLOSE_FRONT_UR			= new Vowel(8, "i\u0303\u02D0", Length.LONG, Nasalization.NASAL, Height.CLOSE, Backness.FRONT, Roundedness.UNROUNDED); 	// i~:
//	public static final Vowel CLOSE_MID_FRONT_UR		= new Vowel(124, "e", Height.CLOSE_MID, Backness.FRONT, Roundedness.UNROUNDED); 										// ui
	public static final Vowel LN_OPEN_CENTRAL_UR		= new Vowel(7, "a\u0303\u02D0", Length.LONG, Nasalization.NASAL, Height.OPEN, Backness.CENTRAL, Roundedness.UNROUNDED);	// a~:
//	public static final Vowel CLOSE_MID_FRONT_UR		= new Vowel(124, "e", Height.CLOSE_MID, Backness.FRONT, Roundedness.UNROUNDED); 										// ei
	public static final Vowel N_CLOSE_BACK_UR			= new Vowel(7, "\u026F\u0303", Nasalization.NASAL, Height.CLOSE, Backness.BACK, Roundedness.UNROUNDED); 					// uu~
	public static final Vowel LN_CLOSE_BACK_RD			= new Vowel(7, "u\u0303\u02D0", Length.LONG, Nasalization.NASAL, Height.CLOSE, Backness.BACK, Roundedness.ROUNDED); 		// u~:
//	public static final Vowel CLOSE_MID_FRONT_UR		= new Vowel(124, "e", Height.CLOSE_MID, Backness.FRONT, Roundedness.UNROUNDED); 										// Oi
	public static final Vowel N_OPEN_BACK_UR			= new Vowel(6, "\u0251\u0303", Nasalization.NASAL, Height.OPEN, Backness.BACK, Roundedness.UNROUNDED); 					// a_~
