...
public class Data {
	...
	public static final Consonant[] CLICKS = { Consonant.VL_DENTAL_AFFRICATED_CLICK,
			Consonant.NASALIZED_VD_DENTAL_AFFRICATED_CLICK };
	...
	public static final Consonant[] LABIAL_VELARS = { Consonant.VD_LABIAL_VELAR_STOP,
			Consonant.VD_LABIAL_VELAR_NASAL, Consonant.PRENASALIZED_VD_LABIAL_VELAR_STOP };
	...
	// Vowel categories
	public static final Vowel[] NASAL_VOWELS = { Vowel.N_CLOSE_BACK_RD, Vowel.N_CLOSE_BACK_UR,
			Vowel.N_CLOSE_CENTRAL_UR, Vowel.N_CLOSE_FRONT_UR, Vowel.N_MID_BACK_RD, Vowel.N_MID_CENTRAL_UR,
			Vowel.N_MID_FRONT_UR, Vowel.N_NEAR_CLOSE_NEAR_BACK_RD, Vowel.N_NEAR_CLOSE_NEAR_FRONT_UR,
			Vowel.N_NEAR_OPEN_FRONT_UR, Vowel.N_OPEN_BACK_UR, Vowel.N_OPEN_CENTRAL_UR, Vowel.N_OPEN_MID_BACK_RD,
			Vowel.N_OPEN_MID_FRONT_UR, Vowel.LN_CLOSE_BACK_RD, Vowel.LN_CLOSE_FRONT_UR, Vowel.LN_OPEN_CENTRAL_UR };
